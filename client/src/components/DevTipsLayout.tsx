...
const NAV_ITEMS = [
  { path: "/admin/dev-tips", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { path: "/admin/dev-tips/settings", label: "Settings", icon: Settings },
];
...
export default function DevTipsLayout({ children, title, subtitle }: Props) {
  const { user } = useAuth();
      ...
      <aside className="w-64 flex-shrink-0 bg-gray-950 border-r border-gray-800 flex flex-col">
        ...
        <div className="p-3 border-t border-gray-800">
          <div className="flex items-center gap-2 px-3 py-2 bg-gray-900 rounded-lg">
            <div className="w-7 h-7 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center text-xs font-bold">
