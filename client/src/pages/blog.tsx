                ...
                <article className="blog-card mb-10 cursor-pointer group md:flex">
                  <div className="md:w-2/5 aspect-video md:aspect-auto overflow-hidden">
                    {featured.coverImage ? (
                      ...
                      >
                        <img src="/arcolytelogo.png" alt="ARCOLYTE TECHNOLOGIES" className="w-20 h-20 opacity-60" />
                      </div>
                    )}
                  </div>
                  ...
                  >
                    <div className="aspect-video overflow-hidden">
                      {post.coverImage ? (
                        ...
                        >
                          <img src="/arcolytelogo.png" alt="ARCOLYTE TECHNOLOGIES" className="w-12 h-12 opacity-50" />
                        </div>
                      )}
                    </div>
