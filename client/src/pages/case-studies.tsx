...
const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    client: "Retail SME (Lagos)",
    duration: "2 weeks",
    impact: "80% of customer queries answered instantly",
    metricValue: "80%",
    metricLabel: "Query Automation",
    overview:
      "A small business owner was spending 4–6 hours daily answering repetitive WhatsApp questions about products, pricing, availability, and delivery.",
    solution:
      "Deployed a WhatsApp Business API bot powered by a custom FAQ knowledge base and AI intent detection. Handles order status, product catalogue, appointment scheduling, and escalation to human agents.",
    results: [
      "80% of incoming queries fully automated",
      "24/7 availability with zero staff cost",
  ...
  },
  {
    ...
    client: "Retail E-Commerce Store",
    duration: "2 weeks",
    impact: "Real-time inventory sync across 3 platforms",
    metricValue: "99%",
    metricLabel: "Sync Accuracy",
    overview:
      "A retail merchant was selling on WooCommerce, Jumia, and Konga simultaneously. Manual product updates caused overselling, stock mismatches, and customer complaints.",
    solution:
      "Built a middleware sync service that listens for inventory changes in WooCommerce and propagates updates to Jumia and Konga via their seller APIs within 60 seconds.",
    results: [
      "Real-time inventory sync — < 60 second propagation",
      "99% stock accuracy across all platforms",
      "Update time: from 4 hours to 5 minutes",
